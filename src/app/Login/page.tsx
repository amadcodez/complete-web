      ...
      <div className="screenMiddleDiv">
        <div className="formDiv">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="formButton hover:text-white font-semibold bg-[#6f8d86] hover:bg-[#5a726b] transition">
              Login
            </button>


            <div className="text-center mt-4">
              <a href="#" className="font-semibold text-[#9fb1ad] hover:underline">
